...
DISCORD_TOKEN = os.getenv("MTQ5ODI0NTM5NTY2MTE5MzMwNg.Gv_YWS.KlEErdRWkAkxxEp16GGuptxORW3bMDoR5Gfl1s")
CLAUDE_API_KEY = os.getenv("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")
FYERS_APP_ID = os.getenv("R19GD9BCZH-200")
FYERS_ACCESS_TOKEN = os.getenv("eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9..wqhK8AW16nlH2a-_40qjusZTONvRS8DhfMCQ22YAfxI")
CHANNEL_ID = int(os.getenv("1498261283584217219")
COOLDOWN_SECONDS = 60
last_run_time = 0
